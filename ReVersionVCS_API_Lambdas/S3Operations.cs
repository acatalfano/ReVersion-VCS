...
namespace ReVersionVCS_API_Lambdas
{
    public class S3Operations
    {
        ...
        private const string bucketPrefix = "ReVersionVCS";
        ...
        */
        ...
        private static async Task<PutBucketResponse> CreateBucketAsync(string bucketName)
        {
            try
            {
        ...
        private static async Task<string> FindBucketLocationAsync(string repositoryName, string branchName)
        {
        ...
        private static async Task<List<string>> GetObjectKeysAsync(string bucketName, string prefix = null)
        {
        ...
        private static async Task<PutObjectResponse> UpdateObjectAsync(FileData file)
        {
            try
            {
        ...
        private static async Task<string> GetObjectContentAsync(string repoName, string branchName, string objectKey)
        {
        ...
        private static string GetBucketName(string repoName, string branchName)
