...
namespace ReVersionVCS_API_Lambdas
{
    public class HierarchyNode : IEquatable<HierarchyNode>
    {
        ...
        public override string ToString() => Name + (!IsFile ? "/" : "");
        ...
        public override int GetHashCode() => HashCode.Combine(Name, IsFile);
    ...
    public class FileHierarchyData
    {
        ...
        */
        public HierarchyNode GetHierarchyList()
        {
            HierarchyNode node = new HierarchyNode
            {
                Name = "",
                IsFile = root.IsFileNode,
                Children = new List<HierarchyNode>()
            };

            node.Children.AddRange(GetChildren(root));
            return node;
        }
        
        private List<HierarchyNode> GetChildren(Node node)
        {
            List<HierarchyNode> children = new List<HierarchyNode>();

            if (node.IsLeafNode()) return children;
